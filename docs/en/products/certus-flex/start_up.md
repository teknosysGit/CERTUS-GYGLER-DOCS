---
title: Start-Up
summary: Describes the initial setup and start-up procedures for {{ variables.product.software.name.en }} software.
authors:
    - Arnold Zueger
    - Reto Gyger
date: February 2026
...
!!! danger "Hazard: **Danger to life from handling toxic or highly reactive substances**"

    ![Handling Toxic](../../../_shared_assets/icon_handling_toxic.png){ .img-icon width="80" height="80" }
...
!!! warning "Warning: **Risk of electrical injury**"
    ...
    ![Electrical Hazard](../../../_shared_assets/icon_electric_shock.png){ .img-icon width="80" height="80" }
...
!!! caution "Caution: **Risk of crushing due to axial movement**"
    ...
    ![Crushing Due to Axial Movement](../../../_shared_assets/icon_crushing.png){ .img-icon width="80" height="80" }
...
Delivered in two separate packages, the {{ variables.product.name.en }} starter kit consists of the following components (which vary depending on which ones have been selected):


| **Package A (655 x 535 x 288 mm):**                                                 |
| ----------------------------------------------------------------------------------- |
| ![Package A](../_assets/images/box1.png){ width=200 alt="Box" }                                                                                    |
| A4 page: axis lock warning label                                                    |
| Binder: {{ variables.product.name.en }} user manual                                                     |
...
| --------------------------------------------------------------- |
| ![Package B](../_assets/images/box2.png){ width=200 alt="Box" } |
...
► Carefully unpack the delivered package(s).
  ...
  Check all the components for completeness and integrity using the ordering documentation and the table above. 
  Should they be incomplete or damaged, please contact your distributor.
...
## {{ variables.product.name.en }} – Start-Up

During the start-up, {{ variables.product.name.en }} is prepared for operation.

It is the time when all necessary measures are taken to ensure the seamless functioning of
{{ variables.product.software.name.en }}.

!!! note
    {{ variables.product.name.en }} may only be started up by qualified service and maintenance personnel.
...
![ Waste tray at the Base Unit](../_assets/images/waste-tray.png "Installation: Waste tray at the Base Unit"){ .img-medium .on-glb width="350" height="150" }
...
!!! note
    ...
    ![Main switch](../_assets/images/main-switch.png){ width="80" height="80"}

![Base Unit Connections](../_assets/images/base_unit_connections.png "Base Unit Connections"){ .img-medium .on-glb width="350" height="150" }

![Cable and connecting points](../_assets/images/cables_connecting_points.png "Cables, Connection Points"){ .img-medium .on-glb width="350" height="150" }

### Putting on the Dispensing Head

► Put on the dispensing head onto the Y axis and fasten it with the screw (Torx, T20).

!!! note "Note: **Malfunctioning due to a damaged component**"
...
![Installation Dispensing head](../_assets/images/installation_dispensing_head.png "Installation: Dispensing Head on the Y Axis"){ .img-medium .on-glb width="450" height="250" }
...
![Installation Micro Valves](../_assets/images/macro_valve_on_dispensing_head.png "Installation: Micro valve on the Dispensing Head"){ .img-medium .on-glb width="450" height="250" }
...
!!! note
    ...
    Ordered bottle kits are delivered fully assembled.
    (Steps 1 through 6 can be omitted.)

► Read the following sections before installing a bottle kit:

- [Bottle Kit – Assembly](assembly_and_operation.md#bottle-kit--assembly).

- [Bottle Kit – Operational Chart](assembly_and_operation.md#bottle-kit--operational-chart).

- [Fluid Change - Bottle Kit](assembly_and_operation.md#fluid-change---bottle-kit).


!!! warning "Warning:**Risk of fluid spillage**"

    ![Hazard](../../../_shared_assets/icon_handling_toxic.png){ width="80" height="80" }
    ...
    ► Pour fluid into the container only after the tubes are correctly installed and connected to {{ variables.product.name.en }}.

### Step 1: Cutting tubes to length

Cut the tube (inner Ø=1.6 mm) to desired length using a cutting tool:

![Fluid tube length](../_assets/images/fluid_tube_length.png "Fliuid tube length"){ .img-medium .on-glb width="450" height="250" }

![Compressed Air Tube Length](../_assets/images/compressed_air_tube_length.png "Compressed Air Tube Length"){ .img-medium .on-glb width="450" height="250" }

!!! note      

    Observe the length of the fluid tube (which affects dispensing accuracy).
    The compressed air tube can be cut to any length (at least 400 mm).

!!! note "Note:**Malfunctioning due to tube contamination**"

    ![Malfunctioning Due to Tube Contamination](../../../_shared_assets/icon_collision_risk.png){ width="80" height="80" }
...
![Clamping Sleeve: Orientation and Sequence](../_assets/images/clamping_sleeve.png "Clamping Sleeve: Orientation and Sequence"){ .img-medium .on-glb width="450" height="250" }

!!! warning "Warning: **Malfunctioning due to and risk of fluid spillage**"

    ![Risk of Fluid Spillage](../../../_shared_assets/icon_handling_toxic.png){ width="80" height="80" }
...
|                                                                                   |                                                                                                                                                                                     |
| --------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![End of compressed air tube](../_assets/images/end_of_compressed_air_tube.png) | The end of the compressed air tube should be flush with the clamping sleeve.                                                                                                        |
| ![Fluid tube length](../_assets/images/fluid_tube.png)                            | The distance between the fluid tube end and the bottle bottom should be approx. 5 mm. See [Bottle Kit – Operational Chart](assembly_and_operation.md#bottle-kit-operational-chart). |
...
![Installation: Inlet adapter with fluid tube](../_assets/images/installation_inlet_adaptor.png "Installation: Inlet Adapter with fluid tube"){ .img-medium .on-glb width="550" height="350" }

### Step 4: Driving tubes into bottle caps

All the tubes can only be driven into the bottle cap using the pressure screw.

![Installation: Tube with bottle cap](../_assets/images/installation_tube_with_bottle_cap.png "Installation: Tubes with bottle cap"){ .img-medium .on-glb width="650" height="450" }

1. Tighten the compressed air tube hand-tight using the pressure screw.

2. Tighten the fluid tubes hand-tight using the pressure screw.

    (Insert the tube through the opening in the container)

3. Tighten all unused outlets hand-tight using blind screws.

!!! warning "Warning: **Malfunctioning due to open outlets**"

    ![Malfunctioning Due to Open Outlets](../../../_shared_assets/icon_collision_risk.png){ width="80" height="80" }
...
![Installation: Suction Filter through Fluid Tube](../_assets/images/suction_filter_through_fluid_tube.png "Installation: Suction Filter through Fluid Tube"){ .img-medium .on-glb width="550" height="350" }
...
!!! note
    ...
    Ordered syringe kits are delivered fully assembled.
    (Steps 1 through 5 can be omitted.)

Read the following sections before installing the syringe kit:

► [Syringe Kit – Assembly](assembly_and_operation.md#syringe-kit-assembly).

► [Syringe Kit – Operational Chart](assembly_and_operation.md#syringe-kit-operational-chart).

► [Fluid Change – Syringe Kit](maintenance.md#fluid-change-syringe-kit).
...
!!! warning "Warning: **Risk of fluid spillage**"
    ...
    ► Fill the syringe with fluid only after the tubes are correctly installed and connected to {{ variables.product.name.en }}.

### Step 1: Cutting the compressed air tube to length

Cut the tube (inner Ø=1.6 mm) to desired length using a cutting tool:

![Compressed air tube length](../_assets/images/syringe_compressed_air_tube_length.png "Compressed Air Tube Length"){ .img-medium .on-glb width="450" height="250" }
...
![Placing the Clamping Sleeve](../_assets/images/clamping_sleeve_orientation_and_sequence.png "Clamping Sleeve: Orientation and Sequence"){ .img-medium .on-glb width="450" height="250" }

!!! warning "Warning:**Malfunctioning due to and risk of fluid spillage**"

    ![Risk of Fluid Spillage](../../../_shared_assets/icon_handling_toxic.png){ .img-icon width="80" height="80" }
...
|                                                                                                                                                          |                                                                             |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| ![End of compressed air tube](../_assets/images/compressed_air_tube_end.png){ .img-medium .on-glb width="150" height="50" } | The end ofthe compressed air tube should be flush with the clamping sleeve. |
...
![Installation: Compressed air tube with adapter head](../_assets/images/tube_with_adapter_head.png "Installation: Tube with Adapter Head"){ .img-medium .on-glb width="650" height="450" }
...
![Installation: Inlet adapter with syringe](../_assets/images/inlet_adapter_with_syringe.png "Installation: Inlet adapter with syringe"){ .img-medium .on-glb width="650" height="450" }
...
![Installation: Adapter head with syringe](../_assets/images/adapter_head_with_syringe.png "Installation: Adapter head with syringe"){ .img-medium .on-glb width="650" height="450" }


!!! caution "Caution: **Leakage due to incorrect installation**"

    ![Leakage Due to Incorrect Installation](../../../_shared_assets/icon_collision_risk.png){ .img-icon width="80" height="80" }
    
    The tightness is only ensured when the adapter head is turned 90 degrees.

!!! note "Note: **Fluid spillage during refilling**"

    ![Fluid Spillage During Refilling](../../../_shared_assets/icon_handling_toxic.png){ .img-icon width="80" height="80" }
...
!!! note
    ...
    The micro valves should be screwed onto the dispensing head before the inlet adapter can be installed. See [Installation of the micro valves](#installation-of-the-micro-valves).

![Installation: Bottle/Syringe kit with dispensing head](../_assets/images/installing_bottle_syringe_kit.png "Installation: Bottle/Syringe kit with dispensing head"){ .img-medium .on-glb width="650" height="450" }
...
!!! note "Note: **Regularly check the filling level**"

    ![Regularly Check the Filling Level](../../../_shared_assets/icon_filling_level.png){ .img-icon width="80" height="80" }

    {{ variables.product.name.en }} cannot control the actual filling level of the container. Therefore, it is necessary to regularly check the filling level of the fluid container. The fluid container has always to be filled with fluid so as to prevent dry dispensing. (Dry dispensing reduces the life of the micro valve.)
...
2. Slowly refill the bottles with fluid.
3. Screw the bottle cap onto the bottle and tighten it until the stop.

## Refilling syringe kits

**Procedure**:

1. Turn the adapter head 90 degrees and remove it.
2. Slowly refill the syringe with fluid. (Check it first for possible leakage.)
3. Carefully insert the adapter head into the syringe and turn it 90 degrees.
...
!!! note "Note: **Fluid spillage during syringe refilling**" 

    ![Fluid Spillage During Syringe Refilling](../../../_shared_assets/icon_handling_toxic.png){ .img-icon width="80" height="80" }   
