...
![Assembly, {{ variables.product.name.en }}](_assets/images/certus-flex_assembly.png "{{ variables.product.name.en }} Assembly"){ .img-medium .on-glb width="500", height="350" } 
...
![Operating Principle, {{ variables.product.name.en }}](_assets/images/certus-flex_operating_principle.png "{{ variables.product.name.en }} Operating Principle"){ .img-medium .on-glb width="500", height="350" } 
...
![Base Unit, {{ variables.product.name.en }}](_assets/images/certus-flex_base_unit.png "Base Unit"){ .img-medium .on-glb width="350", height="150" }


### Rating Plate and Interfaces

![Rating Plate and Interfaces](_assets/images/certus-flex_rear_side_interfaces.png "Rear Side, Interfaces"){ .img-medium .on-glb width="750", height="550" }
...
![Status Indicator, {{ variables.product.name.en }}](_assets/images/certus-flex_status_indicator.png "Status Indicators"){ .img-medium .on-glb width="350", height="150" }
...
![Status Indicator, {{ variables.product.name.en }}](_assets/images/certus-flex_bottle_kit_assembly.png "Assembly, Bottle Kit"){ .img-medium .on-glb width="400", height="250" }
...
![Operational Chart, Bottle Kit](_assets/images/certus-flex_bottle_kit_operational_chart.png "Operational Chart, Bottle Kit"){ .img-medium .on-glb width="400", height="250" }
...
![Assembly, Syringe Kit](_assets/images/certus-flex_syringe_kit_assembly.png "Assembly, Syringe Kit"){ .img-medium .on-glb width="400", height="250" }
...
![Operational Chart, Syringe Kit](_assets/images/certus-flex_syringe_kit_operational_chart.png "Operational Chart, Syringe Kit"){ .img-medium .on-glb width="400", height="250" }
...
![Assembly, Bottle Holder](_assets/images/certus-flex_bottle_holder_assembly.png "Assembly, Bottle Holder"){ .img-small .on-glb width="400", height="250" }
...
![Assembly, Dispensing Head](_assets/images/certus-flex_dispensing_head_assembly.png "Assembly, Dispensing Head"){ .img-small .on-glb width="400", height="250" }
...
![Assembly, Dispensing Head at 22°](_assets/images/certus-flex_dispensing_head_assembly_tilt.png "Assembly, Dispensing Head at 22°"){ .img-small .on-glb width="400", height="250" }
...
![Assembly, Magnetic stirrer](_assets/images/certus-flex_dispensing_head_magnetic_stirrer.png "Assembly, Magnetic stirrer"){ .img-medium 
...
![Assembly, SMLD 300GC Micro Valve](_assets/images/certus-flex_SMLD_300GC_micro_valve.png "Assembly, SMLD 300GC Micro Valve"){ .img-large .on-glb width="700", height="550" }
...
![Certus Valve Types and Dispensing Range](_assets/images/certus-flex_valve_types_and_dispensing_range.png "Certus Valve Types and Dispensing Range"){ .img-large .on-glb width="800", height="750" }
...
![Waste Tray](_assets/images/certus-flex_waste_tray.png "Waste Tray with Discharge Function"){ .img-small width="300", height="150" }
...
![Well Plate Holder](_assets/images/certus-flex_well_plate_holder.png "Well Plate Holder"){ .img-small .on-glb width="300", height="150" }
