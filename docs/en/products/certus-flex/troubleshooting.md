...
### CERTUS CONTROL - Protocol Validator

The most likely error messages of CERTUS CONTROL‘s Protocol Validator are listed here. More support is available from service personnel or your distributor.
...
??? note "Evaporation volume out of calibration range. 110.0 μl with channel 3 is not within range. (Min: 0.031807 μl, Max: 78.849848 μl)"
    ...
    No action is necessary. CERTUS CONTROL informs about a dispensed volume in the evaporation curtain which does not fit into the calibrated area. Some deviations may occur.
