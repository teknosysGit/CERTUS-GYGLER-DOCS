...
!!! warning "Warning: Risk of electrical injury"
    ...
    ![Risk of Electrical Injury](../../../_shared_assets/icon_electric_shock.png){ .img-icon width="80px" height="80px"}
...
!!! warning "Warning: Risk of fluid spillage"
    ...
    ![Risk of Fluid Spillage](../../../_shared_assets/icon_handling_toxic.png){ .img-icon width="80px" height="80px"}
...
!!! note "Note: Environmental risk due to improper disposal"
    ...
    ![Environmental Risk](../../../_shared_assets/icon_environmental_risk.png){ .img-icon width="80px" height="80px"}
...
!!! note "Note: Inlet adapter without micro valve"
    ...
    ![Toxic Handling](../../../_shared_assets/icon_handling_toxic.png){ .img-icon width="80px" height="80px"}
...
2. Unscrew the micro valve from the dispensing head. (If you cannot loosen it manually, use the valve key)

3. (Option) Clean the micro valve with the cleaning kit.

4. Store the micro valve in its container.
...
2. Fasten and tighten the micro valve to the dispensing head hand-tight.

3. Insert the inlet adapter and tighten the screw hand-tight. It is well inserted once it snaps into the O-ring.

4. Mount the fluid tube or syringe onto the inlet adapter.

5. Execute the Flush function before using the micro valve. For this purpose, see [Flush](operations.md#flush).
...
!!! warning "Warning: Spillage when removing the syringe kit"
    ...
    ![Spillage](../../../_shared_assets/icon_handling_toxic.png){ .img-icon width="80px" height="80px"}
...
4. Loosen the hand screw of the dispensing head.
    
    ![Hand Screw Loosing](_assets/images/hand_screw_loosing.png){ .img-medium width="200px" height="200px"}

5. Remove the syringe with the installed dispensing head.

    ![Removing Syringe](_assets/images/removing_syringe.png){ .img-medium width="200px" height="200px"}

6. Install a new or cleaned syringe kit with inlet adapter onto the dispensing head. For more purpose, see [Installing the Bottle/Syringe Kit on the Dispensing Head](start-up.md#installing-the-bottle-syringe-kit-on-the-dispensing-head).
7. Refill the syringe with fluid.
8. Execute the *Flush* with the relevant channel. See [Flush](operations.md#flush).
9.  Execute the *Flush* until all fluid in the micro valve is dispensed.
...
2. Loosen the hand screw of the dispensing head.

    ![Dispensing Head Hand Screw](_assets/images/dispensing_head_hand_screw.png){ .img-medium width="200px" height="200px"}

3. Remove the tube with the installed inlet adapter from the dispensing head.
 
    ![Removing the Tube](_assets/images/removing_tube.png){ .img-medium width="200px" height="200px"}

4. Remove the compressed air tube from the compressed air manifold.
...
!!! tip "Tip"
    ...
    ![Loosing Ring Pressing](_assets/images/loosing_ring.png){ .img-icon width="200px" height="200px"} ![Removing the Compressed Air Tube](_assets/images/removing_compressed_air_tube.png){ .img-icon width="200px" height="200px"}
...
![Power Input Protection Housing](_assets/images/power_input_protection_housing.png "Fuse Location"){ .img-medium width="250px" height="150px"}

!!! note "Note: **For trained personnel only**"
    ![Electric Shock](../../../_shared_assets/icon_electric_shock.png){ .img-icon width="80px" height="80px"}
...
!!! note "Note: **Electronic components**"
    ...
    ![Electronic Components](../../../_shared_assets/icon_collision_risk.png){ .img-icon width="80px" height="80px"}
...
!!! note "Note: **Malfunction due to a damaged part**"
    ...
    ![Malfunction Due to Damage](../../../_shared_assets/icon_collision_risk.png){ .img-icon width="80px" height="80px"}
...
2. Loosen the lateral screw of the dispensing head. The screw does not have to be completely removed (it is undetachable).
    ...
    ![Dispensing Head Screw Removal](_assets/images/dispensing_head_lateral_screw_removal.png){.img-medium width="250px" height="150px"}

3. Carefully remove the dispensing head.

    ![Dispensing Head Removal](_assets/images/dispensing_head_removing.png){ .img-medium width="250px" height="150px"}
