...
* Installation files -- USB:
    * Setup {{ variables.product.software.name.en }} {{ variables.product.software.version }} folder \> {{ variables.product.software.name.en }} {{ variables.product.software.version }}
* Installation files -- FTP:
    ...
    * Click the bottom folder (corresponds to the latest release) and download Setup {{ variables.product.software.name.en }} {{ variables.product.software.version }}.zip.
...
1. Double-click to execute `{{ variables.product.software.name.en }} {{ variables.product.software.version }}.msi`.
...
!!! draft
    ...
    !!! note
        ...
        * The necessary installer ndp48-x86-x64-allos-enu.exe can be found in the Setup *{{ variables.product.software.name.en }} {{ variables.product.software.version }}* folder.
...
![Start/Stop SiLA provider](_assets/images/certus_flex_license_not_exist.png)
...
![ {{variables.product.software.name.en }} Login Window](_assets/screenshots/image42.png "{{ variables.product.software.name.en }}, Log-In Window"){ .img-medium .on-glb width="450" height="450"}
...
![ {{variables.product.software.name.en }} Start Menu](_assets/screenshots/image46.png){ .img-medium .on-glb width="450" height="450"}

Fig. 37 {{ variables.product.software.name.en }}, Start Menu
...
![Menu bar](_assets/screenshots/image76.png)
...
|              |                                                                                                                                     |
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------- |
| *Log folder* | Define a customized path for log files. Default: `C:\ProgramData\Gyger\{{ variables.product.software.name.en }}\log`                                          |
...
!!! draft
    ...
    | *Target Name*   | Name used for communication with {{ variables.product.software.name.en }}. |
...
![Operating Principle](_assets/screenshots/image241.png){width="250", height="300"}
...
|     | The format of the csv file must correspond to the {{ variables.product.software.name.en }}.               |
...
2.  **Dispensing head configuration**
    For each channel, it contains the dispensing head ({{ variables.product.shortName.en }}8, {{ variables.product.shortName.en }}5, etc.) and the micro valve used, and informs if the channel is active.
...
![Maintenance](_assets/screenshots/CM_maintenance_menu.png){ .img-medium .on-glb width="350" height="150"}
...
![Maintenance, Live Log](_assets/screenshots/image407.png){ .img-medium .on-glb width="400" height="200"}
...
![Maintenance, Summary](_assets/screenshots/image409.png){ .img-medium .on-glb width="450" height="250"}
...
![Protocol Editor, Summary View](_assets/screenshots/image410.png "Protocol Editor, Summary View"){ .img-medium .on-glb width="450" height="250"}

### Interval Purge Loop (IPL)

![Interval Purge, Menu](_assets/screenshots/image411.png){ .img-medium .on-glb width="450" height="250"}
...
![Protocol Context menu](_assets/screenshots/protocol_context_menu.png "Protocol Context Menu")
...
![Add new Layer](_assets/screenshots/protocol_context_layers_menu.png)
...
![Layer 1](_assets/screenshots/protocol_context_layer_added.png){width="150" height="50"}
...
![Region context menu](_assets/screenshots/protocol_context_region.png)
...
![Regional Editor, Axial Movement](_assets/images/region_editor_axial_movement.png "Regional Editor, Axial Movement")
...
![Dispensing Functions](_assets/screenshots/dispensing_functions.png)
...
![Discrete Volumes Editor](_assets/screenshots/discrete_settings.png)
...
The well is refilled up to the specified value while taking into account preceding dispensa- tions.

![Backfill Settings](_assets/screenshots/backfill_settings.png){width="729" height="89"}
