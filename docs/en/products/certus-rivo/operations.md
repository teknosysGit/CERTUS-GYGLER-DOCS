...
!!! note
    The following sections explain step by step how to use an empty template for a {{ variables.product.shortName.en }}8 dispensing head.
...
* Click Head and Supply configuration\...
    ...
    ![Head and Supply Configuration](_assets/screenshots/head_and_supply_configuration.png){ .img-medium .on-glb width="550" height="250" }

* Under the *TEMPLATE* column, select an empty *Empty {{ variables.product.shortName.en }}8* template and apply by double-clicking it. Alternatively right-click > *apply*.

    ![Template Manager, Template Column](_assets/screenshots/template_manager_template_column.png){ .img-medium .on-glb width="350" height="150" }
...
Right-click on template =\> *Save as\...* opens the following window:
[Template Manager](#template_manager)

![Template Manager, Save As Template](_assets/screenshots/template_manager_save_as_template.png){ .img-medium .on-glb width="350" height="150" }
...
![Channel Configuration](_assets/screenshots/certus_control_configuring_channels.png){ .img-medium .on-glb width="550" height="350" }
...
![Factor Value](_assets/screenshots/channel_configuration_adapting_factor_value.png){ .img-medium .on-glb width="350" height="250" }
...
![Maintenance Menu](_assets/screenshots/protocol_editor_maintenance_menu.png){ .img-medium width="450" height="350" }
...
![Click to Flush](_assets/screenshots/click_to_flush.png){ .img-medium .on-glb width="550" height="350" }
...
* Enable compressed air, under Air.
    ...
    ![Enable Compressed Air](_assets/screenshots/flush_enable_compressed_air.png){ .img-medium .on-glb width="550" height="350" }
...
![Preparation Prime](_assets/screenshots/preparation_prime.png){ .img-medium .on-glb width="550" height="350" }
...
![Cleaning Purge](_assets/screenshots/cleaning_purge.png){ .img-medium .on-glb width="550" height="350" }
...
![Cleaning Clean Cycle](_assets/screenshots/cleaning_clean_cycle.png){ .img-medium .on-glb width="550" height="350" }
...
![Interval Purge Loop Menu](_assets/screenshots/ipl_menu.png){ .img-medium .on-glb width="350" height="150" }
