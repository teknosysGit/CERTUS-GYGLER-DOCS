...
summary: Guidelines for the transportation and storage of {{ variables.product.name.en }} equipment.
authors:
    - Arnold Zueger
    - Reto Gyger
...
!!! warning "Risk of injury due to falling or tipping items"
	![Risk of Injury](../../../_shared_assets/icon_injury_by_falling.png){ .img-icon width=80 height=100}   
...
!!! draft
    ...
    |                                                                  |                                                                 |
    | ---------------------------------------------------------------- | --------------------------------------------------------------- |
    | ![Packaging](_assets/images/packaging.png "Packaging" ){width=200 height=100} | **Length**: 660 mm <br>**Width**: 550 mm <br>**Height**: 320 mm <br>**Weight**: approx. 20-22 kg |
    ...
    | ![This Way Up](_assets/images/this_way_up.png){width=100 height=80} | ![Fragile](_assets/images/fragile.png){width=100 height=80} | ![Keep dry](_assets/images/keep_dry.png){width=100 height=80} |
    | :------------------------------------------------------------------: | :----------------------------------------------------------: | :-----------------------------------------------------------: |
    ...
    !!! note "Environmental risk due to improper disposal"
        ...
        ![Environmental Risk](../../../_shared_assets/icon_environmental_risk.png){ .img-icon width=80 height=80}
