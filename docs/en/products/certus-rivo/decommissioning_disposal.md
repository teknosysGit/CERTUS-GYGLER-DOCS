...
summary: Describes the proper decommissioning procedures for {{ variables.product.software.name.en }} software and its components.
authors:
    - Arnold Zueger
    - Reto Gyger
date: February 2026
...
!!! warning "Risk of electrical injury"
    ![Electrical Injury](../../../_shared_assets/icon_electric_shock.png){ .img-icon width="80px" height="80px"}
