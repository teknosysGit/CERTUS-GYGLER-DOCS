...
![{{ variables.product.name.en }} Web Control Home Page](_assets/screenshots/certus_flex_web_control_home_page.png){.img-medium}

► Select the desired {{ variables.product.name.en }} on the home page

![{{ variables.product.name.en }} Web Control Select Flex Dispenser](_assets/screenshots/certus_flex_web_control_home_page_dispenser.png){.img-medium}
